...
public class ChatAdapter extends SimpleCursorAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		@SuppressLint("Range") long dateMilliseconds = cursor.getLong(cursor
				.getColumnIndex(ChatProvider.ChatConstants.DATE));

		@SuppressLint("Range") int _id = cursor.getInt(cursor
				.getColumnIndex(ChatProvider.ChatConstants._ID));
		String date = TimeUtil.getChatTime(dateMilliseconds);
		@SuppressLint("Range") String message = cursor.getString(cursor
				.getColumnIndex(ChatProvider.ChatConstants.MESSAGE));
		@SuppressLint("Range") int come = cursor.getInt(cursor
				.getColumnIndex(ChatProvider.ChatConstants.DIRECTION));// message
		boolean from_me = (come == ChatConstants.OUTGOING);
		@SuppressLint("Range") String jid = cursor.getString(cursor
				.getColumnIndex(ChatProvider.ChatConstants.JID));
		@SuppressLint("Range") int delivery_status = cursor.getInt(cursor
