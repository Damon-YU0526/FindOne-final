...
public class SmackImpl implements Smack {
	...
	public boolean login(String account, String password) throws XXException {
		try {
			...
			registerRosterListener();// listener server
			...
			initServiceDiscovery();// Exchange message listening with the server. Send a message with a receipt is sent successfully
	...
	/***************** end Handle the message sending failure status ***********************/
	/***************** start Process ping server messages ***********************/
	...
	/***************** end Process ping server messages ***********************/

	/***************** start Sending an Offline Message ***********************/
	...
	/***************** end Sending an Offline Message ***********************/
	/******************************* start Contact database event handling **********************************/
